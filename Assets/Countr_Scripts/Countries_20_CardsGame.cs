...
public class Countries_20_CardsGame : MonoBehaviour
{
    ...
    private void SaveScore(int score)
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            scores.Add(PlayerPrefs.GetInt("Countries_20_Score_" + i, 0));
        }
        ...
        {
            PlayerPrefs.SetInt("Countries_20_Score_" + i, scores[i]);
        }
