...
public class Vegetables_8_CardsGame : MonoBehaviour
{
    ...
    private void SaveScore(int score)
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            scores.Add(PlayerPrefs.GetInt("Vegetables_8_Score_" + i, 0));
        }
        ...
        {
            PlayerPrefs.SetInt("Vegetables_8_Score_" + i, scores[i]);
        }
