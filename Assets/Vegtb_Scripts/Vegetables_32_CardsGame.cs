...
public class Vegetables_32_CardsGame : MonoBehaviour
{
    ...
    private void CheckForGameOver()
    {
        if (matchesFound == cards.Count / 2)
        {
            ...
            if (!isEasyMode)
            {
                ...
                if (difficulty == "HARD")
                {
                    currentScore += Mathf.RoundToInt(timeLeft * 10000);
                }
                else
                {
                    currentScore += Mathf.RoundToInt(timeLeft * 100);
                }
    ...
    private void SaveScore(int score)
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            scores.Add(PlayerPrefs.GetInt("Vegetables_32_Score_" + i, 0));
        }
        ...
        {
            PlayerPrefs.SetInt("Vegetables_32_Score_" + i, scores[i]);
        }
