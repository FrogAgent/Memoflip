...
public class Countries_24_CardsGame : MonoBehaviour
{
    ...
    private void SaveScore(int score)
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            scores.Add(PlayerPrefs.GetInt("Countries_24_Score_" + i, 0));
        }
        ...
        {
            PlayerPrefs.SetInt("Countries_24_Score_" + i, scores[i]);
        }
