...
public class Countries_32_CardsGame : MonoBehaviour
{
    ...
    private void SaveScore(int score)
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            scores.Add(PlayerPrefs.GetInt("Countries_32_Score_" + i, 0));
        }
        ...
        {
            PlayerPrefs.SetInt("Countries_32_Score_" + i, scores[i]);
        }
